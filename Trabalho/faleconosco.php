...
?>
       ...
       <p>
            <label for id="escolhalogin"> Escolha um Login</label>
        ...
        <p>
          <label for id="senha">Senha</label>
            <input type="password" name="lenha" placeholder="Escolha uma senha">
        </p>
         <p>
          <label for id="repsenha">Repetir Senha</label>
            <input type="password" name="senha" placeholder="Repita asenha">
         </p>
